...
export default function SearchSortSelector({
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-slate-200/80 bg-slate-50/70 px-2.5 py-1.5 shadow-[0_1px_2px_rgba(15,23,42,0.04)] ring-1 ring-slate-900/5 dark:border-navy-700 dark:bg-navy-900/70 dark:ring-white/5">
